...
func (db *Database) ReadAncients(fn func(op typedb.AncientReaderOp) error) (err error) {
	return fn(db)
}
...
func (db *Database) ModifyAncients(f func(typedb.AncientWriteOp) error) (int64, error) {
	panic("not supported")
}
...
//func (db *Database) NewSnapshot() (typedb.Snapshot, error) {
//	panic("not supported")
//}
...
func New(endpoint string) (typedb.Database, error) {
