...
func NewID(config *entity.ChainConfig, genesis entity.Hash, head uint64) ID {
...
func NewStaticFilter(config *entity.ChainConfig, genesis entity.Hash) Filter {
...
func newFilter(config *entity.ChainConfig, genesis entity.Hash, headfn func() uint64) Filter {
...
func gatherForks(config *entity.ChainConfig) []uint64 {
	// Gather all the fork block numbers via reflection
	kind := reflect.TypeOf(entity.ChainConfig{})
