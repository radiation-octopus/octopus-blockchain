...
func (bnh *BlockNumberOrHash) Hash() (entity.Hash, bool) {
	if bnh.BlockHash != nil {
		return *bnh.BlockHash, true
	}
	return entity.Hash{}, false
}
...
func BlockNumberOrHashWithHash(hash entity.Hash, canonical bool) BlockNumberOrHash {
	return BlockNumberOrHash{
		BlockNumber:      nil,
		BlockHash:        &hash,
