...
func (p *Peer) Handshake(network uint64, td *big.Int, head entity.Hash, genesis entity.Hash, forkID forkid.ID, forkFilter forkid.Filter) error {
...
func (p *Peer) readStatus(network uint64, status *StatusPacket, genesis entity.Hash, forkFilter forkid.Filter) error {
