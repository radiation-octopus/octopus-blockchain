...
type NodeInfo struct {
	...
	Genesis    entity.Hash         `json:"genesis"`    // SHA3 hash of the host's genesis block
	Config     *entity.ChainConfig `json:"config"`     // Chain configuration for the fork rules
	Head       entity.Hash         `json:"head"`       // Hex hash of the host's best owned block
}

// nodeInfo retrieves some `eth` protocol metadata about the running host node.
func nodeInfo(chain *blockchain.BlockChain, network uint64) *NodeInfo {
