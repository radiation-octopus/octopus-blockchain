...
type peerConnection struct {
	...
	lacking map[entity.Hash]struct{} // Set of hashes not to request (didn't have previously)
...
type LightPeer interface {
	Head() (entity.Hash, *big.Int)
	RequestHeadersByHash(entity.Hash, int, int, bool, chan *eth.Response) (*eth.Request, error)
...
type Peer interface {
	LightPeer
	RequestBodies([]entity.Hash, chan *eth.Response) (*eth.Request, error)
	RequestReceipts([]entity.Hash, chan *eth.Response) (*eth.Request, error)
}
...
func (w *lightPeerWrapper) Head() (entity.Hash, *big.Int) { return w.peer.Head() }
func (w *lightPeerWrapper) RequestHeadersByHash(h entity.Hash, amount int, skip int, reverse bool, sink chan *eth.Response) (*eth.Request, error) {
...
func (w *lightPeerWrapper) RequestBodies([]entity.Hash, chan *eth.Response) (*eth.Request, error) {
	panic("RequestBodies not supported in light client mode sync")
}
func (w *lightPeerWrapper) RequestReceipts([]entity.Hash, chan *eth.Response) (*eth.Request, error) {
...
func (p *peerConnection) Reset() {
	...
	p.lacking = make(map[entity.Hash]struct{})
}
...
func (p *peerConnection) MarkLacking(hash entity.Hash) {
	p.lock.Lock()
	defer p.lock.Unlock()
...
func (p *peerConnection) Lacks(hash entity.Hash) bool {
	p.lock.RLock()
...
type peerSet struct {
	...
	rates  *msgrate.Trackers // Set of rate trackers to give the sync a entity beat
