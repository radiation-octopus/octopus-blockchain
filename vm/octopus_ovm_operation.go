...
func validate(jt JumpTable) JumpTable {
	for i, op := range jt {
		...
		// 解释器假设如果设置了memorySize函数，那么也会设置dynamicGas函数。
		//这是一个有点武断的假设，如果需要的话可以删除——但它允许我们避免条件检查。
		//只要我们有这个假设，这个小小的理智检查就会阻止我们合并到违反它的变更中。
...
// newHomesteadInstructionSet返回可以在homestead阶段执行的边界和homestead指令。
