...
var (
	...
	DerivationSignatureHash = sha256.Sum256(entity.Hash{}.Bytes())
)
...
func (w *Wallet) makeAccount(address entity.Address, path accounts.DerivationPath) accounts.Account {
...
func (s *Session) pair(secret []byte) (smartcardPairing, error) {
	...
	return smartcardPairing{
		...
		Accounts:     make(map[entity.Address]accounts.DerivationPath),
	}, nil
}
