...
func (api *ExternalSigner) SignData(account accounts.Account, mimeType string, data []byte) ([]byte, error) {
	...
	var signAddress = entity.NewMixedcaseAddress(account.Address)
...
func (api *ExternalSigner) SignTx(account accounts.Account, tx *block.Transaction, chainID *big.Int) (*block.Transaction, error) {
	data := hexutil.Bytes(tx.Data())
	var to *entity.MixedcaseAddress
	if tx.To() != nil {
		t := entity.NewMixedcaseAddress(*tx.To())
		to = &t
	}
	args := &apitypes.SendTxArgs{
		...
		To:    to,
		From:  entity.NewMixedcaseAddress(account.Address),
	}
	switch tx.Type() {
	case block.LegacyTxType, block.AccessListTxType:
		args.GasPrice = (*hexutil.Big)(tx.GasPrice())
	case block.DynamicFeeTxType:
...
func (api *ExternalSigner) SignTxWithPassphrase(account accounts.Account, passphrase string, tx *block.Transaction, chainID *big.Int) (*block.Transaction, error) {
...
func (api *ExternalSigner) listAccounts() ([]entity.Address, error) {
