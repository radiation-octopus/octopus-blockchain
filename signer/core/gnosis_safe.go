...
type GnosisSafeTx struct {
	...
	SafeTxHash entity.Hash             `json:"contractTransactionHash"`
	Sender     entity.MixedcaseAddress `json:"sender"`
	// These fields are used both on input and output
	Safe           entity.MixedcaseAddress `json:"safe"`
	To             entity.MixedcaseAddress `json:"to"`
	Value          math.Decimal256         `json:"value"`
	GasPrice       math.Decimal256         `json:"gasPrice"`
	Data           *hexutil.Bytes          `json:"data"`
	Operation      uint8                   `json:"operation"`
	GasToken       entity.Address          `json:"gasToken"`
	RefundReceiver entity.Address          `json:"refundReceiver"`
	BaseGas        big.Int                 `json:"baseGas"`
	SafeTxGas      big.Int                 `json:"safeTxGas"`
	Nonce          big.Int                 `json:"nonce"`
	InputExpHash   entity.Hash             `json:"safeTxHash"`
...
// entity validations, e.g. look up 4byte destinations
