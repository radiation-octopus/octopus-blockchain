...
func (api *SignerAPI) SignData(ctx context.Context, contentType string, addr entity.MixedcaseAddress, data interface{}) (hexutil.Bytes, error) {
...
func (api *SignerAPI) determineSignatureFormat(ctx context.Context, contentType string, addr entity.MixedcaseAddress, data interface{}) (*SignDataRequest, bool, error) {
	var (
		req          *SignDataRequest
...
func cliqueHeaderHashAndRlp(header *block.Header) (hash, rlp []byte, err error) {
...
// - the signature,
// - and/or any error
func (api *SignerAPI) SignTypedData(ctx context.Context, addr entity.MixedcaseAddress, typedData apitypes.TypedData) (hexutil.Bytes, error) {
...
func (api *SignerAPI) signTypedData(ctx context.Context, addr entity.MixedcaseAddress,
...
func (api *SignerAPI) EcRecover(ctx context.Context, data hexutil.Bytes, sig hexutil.Bytes) (entity.Address, error) {
	...
	if len(sig) != 65 {
		return entity.Address{}, fmt.Errorf("signature must be 65 bytes long")
	}
...
func UnmarshalValidatorData(data interface{}) (apitypes.ValidatorData, error) {
	...
	return apitypes.ValidatorData{
		Address: entity.BytesToAddress(addrBytes),
