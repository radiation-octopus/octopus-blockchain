...
func (l *AuditLogger) List(ctx context.Context) ([]entity.Address, error) {
...
func (l *AuditLogger) New(ctx context.Context) (entity.Address, error) {
...
func (l *AuditLogger) SignTransaction(ctx context.Context, args apitypes.SendTxArgs, methodSelector *string) (*ethapi.SignTransactionResult, error) {
	...
	if res != nil {
		l.log.Info("SignTransaction", "type", "response", "data", entity.Bytes2Hex(res.Raw), "error", e)
	} else {
...
func (l *AuditLogger) SignData(ctx context.Context, contentType string, addr entity.MixedcaseAddress, data interface{}) (hexutil.Bytes, error) {
	...
	l.log.Info("SignData", "type", "response", "data", entity.Bytes2Hex(b), "error", e)
	return b, e
}

func (l *AuditLogger) SignGnosisSafeTx(ctx context.Context, addr entity.MixedcaseAddress, gnosisTx GnosisSafeTx, methodSelector *string) (*GnosisSafeTx, error) {
	sel := "<nil>"
	if methodSelector != nil {
		sel = *methodSelector
	}
...
func (l *AuditLogger) SignTypedData(ctx context.Context, addr entity.MixedcaseAddress, data apitypes.TypedData) (hexutil.Bytes, error) {
	...
	l.log.Info("SignTypedData", "type", "response", "data", entity.Bytes2Hex(b), "error", e)
	return b, e
}

func (l *AuditLogger) EcRecover(ctx context.Context, data hexutil.Bytes, sig hexutil.Bytes) (entity.Address, error) {
	l.log.Info("EcRecover", "type", "request", "metadata", MetadataFromContext(ctx).String(),
		"data", entity.Bytes2Hex(data), "sig", entity.Bytes2Hex(sig))
