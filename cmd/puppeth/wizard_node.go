...
func (w *wizard) deployNode(boot bool) {
	...
	if err != nil {
		if boot {
			infos = &nodeInfos{port: 58888, peersTotal: 512, peersLight: 256}
		} else {
			infos = &nodeInfos{port: 58888, peersTotal: 50, peersLight: 0, gasTarget: 7.5, gasLimit: 10, gasPrice: 1}
		}
	}
	existed := err == nil
	...
	if !boot {
		...
		//		infos.etherbase = w.readDefaultAddress(entity.HexToAddress(infos.etherbase)).Hex()
		//	}
