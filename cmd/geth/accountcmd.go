...
func unlockAccount(ks *accounts.KeyStore, address string, i int, passwords []string) (accounts.Account, string) {
...
func ambiguousAddrRecovery(ks *accounts.KeyStore, err *accounts.AmbiguousAddrError, auth string) accounts.Account {
...
func accountCreate(ctx *cli.Context) error {
	...
	account, err := accounts.StoreKey(keydir, password, scryptN, scryptP)
