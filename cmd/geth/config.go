...
import (
	...
	"github.com/radiation-octopus/octopus-blockchain/accounts/external"
...
func makeConfigNode(ctx *cli.Context) (*node.Node, gethConfig) {
	...
	utils.Setoctconfig(ctx, stack, &cfg.Eth)
...
func deprecated(field string) bool {
	switch field {
	case "octconfig.Config.EVMInterpreter":
		return true
	case "octconfig.Config.EWASMInterpreter":
		return true
	default:
		return false
	}
...
func setAccountManagerBackends(stack *node.Node) error {
	...
	am.AddBackend(accounts.NewKeyStore(keydir, scryptN, scryptP))
	if conf.USB {
