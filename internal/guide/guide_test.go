...
func TestAccountManagement(t *testing.T) {
	...
	ks := accounts.NewKeyStore(filepath.Join(workdir, "keystore"), accounts.StandardScryptN, accounts.StandardScryptP)
	...
	tx := types.NewTransaction(0, entity.Address{}, big.NewInt(0), 0, big.NewInt(0), nil)
	chain := big.NewInt(1)
